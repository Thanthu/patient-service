...
class PatientServiceImplTest {
	...
	@Spy
	private PatientDtoToPatientConverter patientDtoToPatientConverter;
	...
	void testUpdateName() {
		...
		assertEquals(savedPatientDto.getFirstName(), updatedFirstName);
		assertEquals(savedPatientDto.getLastName(), updateLastName);
		assertEquals(savedPatientDto.getDob(), DATE);
	}
	...
	void testUpdateDob() {
		...
		PatientDto savedPatientDto = patientService.updateDob(updatedPatientDto);
		
		verify(patientRepository, times(1)).findById(ID);
		verify(patientRepository, times(1)).save(any());
		
		assertEquals(savedPatientDto.getFirstName(), FIRST_NAME);
		assertEquals(savedPatientDto.getLastName(), LAST_NAME);
		assertEquals(savedPatientDto.getDob(), updatedDob);
	}
